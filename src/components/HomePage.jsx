  ...
  return (
    <>
      <div className="top-portion flex justify-between py-5 items-center">
        ...
        <img
          className="w-80 border border-red-700 rounded-xl"
          src="./modified.jpg"
          alt="profile_image"
        />
      </div>
      <div className="bottom-portion flex gap-x-5 border border-red-500 py-10">
        <svg
          className={`fill-[${logoColor}]  cursor-pointer`}
          width="30px"
          height="30px">

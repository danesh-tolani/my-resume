  ...
  return (
    <div className="py-20 border border-red-400" style={{ color: textColor }}>
      ...
      <div className="flex flex-col gap-y-5">
        <h3 className="text-2xl font-medium">Systems Engineer - Infosys Pvt. Ltd. (August 2021 - Present)</h3>
        <p className="w-[80%] pb-5">Working as a PeopleSoft Developer for a US based client.
